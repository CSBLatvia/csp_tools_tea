...
@Component({
  selector: 'viz-circles-sectors-ugly',
  templateUrl: './viz-circles-sectors-ugly.component.html',
  styleUrls: ['../../../viz-styles/viz-component.scss']
})

export class VizCirclesSectorsUglyComponent implements OnInit,OnChanges,OnDestroy {
