...
@Component({
  selector: 'block-m1-t1-links',
  templateUrl: './block-m1-t1-links.component.html',
  styleUrls: ['./block-m1-t1-links.component.scss']
})
export class BlockM1T1LinksComponent extends ABlock{
