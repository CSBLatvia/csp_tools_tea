...
@Component({
  selector: 'block-scatter-t1-t2-links',
  templateUrl: './block-scatter-t1-t2-links.component.html',
  styleUrls: ['./block-scatter-t1-t2-links.component.scss']
})
export class BlockScatterT1T2LinksComponent extends ABlock{
