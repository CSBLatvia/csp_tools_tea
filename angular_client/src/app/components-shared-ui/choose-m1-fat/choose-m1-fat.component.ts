...
@Component({
  selector: 'app-choose-m1-fat',
  templateUrl: './choose-m1-fat.component.html',
  styleUrls: ['./choose-m1-fat.component.scss']
})
export class ChooseM1FatComponent extends AChooseUI{
  ...
  override onComponentLanguageChanged():void {
    ...
    this.m1_data.forEach((item:ControlValueVO)=>{
